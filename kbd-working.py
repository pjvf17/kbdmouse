...
hotkeys = {
    ...
    frozenset({'shift'}): HotKey(lambda: speed_change(10, False), lambda: speed_change(SPEED_DEFAULT, False, True)),
    frozenset({'\\'}): HotKey(lambda: speed_change(50, False, True), lambda: speed_change(SPEED_DEFAULT, False, True)),
    frozenset({'u'}): HotKey(lambda: speed_change(0.6, False, True), lambda: speed_change(SPEED_DEFAULT, False, True)),
    frozenset({'h'}): HotKey(lambda: scroll(-15), lambda: scroll(-15),
                             priority=1),
    frozenset({'k'}): HotKey(lambda: scroll(-15), lambda: scroll(-15),
                             priority=1),
    frozenset({'backspace'}): HotKey(lambda: scroll(15), lambda: scroll(-15)),
   # frozenset({'k'}): HotKey(lambda: scroll(10), lambda: scroll(-10)),
  #  frozenset({'i'}): HotKey(lambda: scroll(10), lambda: scroll(-10)),
 #   frozenset({'space'}): HotKey(lambda: scroll(10), lambda: scroll(-10)),
#    frozenset({'shift_r'}): HotKey(lambda: scroll(10), lambda: scroll(-10)),
